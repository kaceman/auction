...
<div x-cloak :class="sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'" class="fixed inset-y-0 left-0 z-30 w-64 overflow-y-auto transition duration-300 transform bg-gray-900 lg:translate-x-0 lg:static lg:inset-0">
    ...
    <nav class="mt-10">
        <a class="flex items-center px-6 py-2 mt-4 text-gray-500 {{request()->routeIs('admin') ? 'bg-gray-700 bg-opacity-25 text-gray-100' : '' }} hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100" href="{{route('admin')}}">
        ...
        <a class="flex items-center px-6 py-2 mt-4 text-gray-500 {{request()->routeIs('admin.articles') ? 'bg-gray-700 bg-opacity-25 text-gray-100' : '' }} hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100" href="{{route('admin.articles')}}">
        ...
        <a class="flex items-center px-6 py-2 mt-4 text-gray-500 {{request()->routeIs('admin.users') ? 'bg-gray-700 bg-opacity-25 text-gray-100' : '' }} hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100" href="{{route('admin.users')}}">
            <svg class="w-6 h-6" viewBox="0 0 28 30" fill="none" xmlns="http://www.w3.org/2000/svg">
